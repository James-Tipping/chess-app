...
import { AbstractBasePiece, ChessPieceColour } from "./AbstractBasePiece";
import { html } from "lit";


@customElement('bishop-piece')
export class BishopPiece extends AbstractBasePiece {
    ...
    return html`
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
        <g style="opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.6)">
          <g style="fill:${this.colour === ChessPieceColour.WHITE ? '#ffffff' : '#000000'}; stroke:#000000; stroke-linecap:butt;">
